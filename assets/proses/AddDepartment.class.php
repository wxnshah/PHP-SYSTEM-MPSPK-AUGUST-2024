...
if (!empty($_POST))
{
	...
	# mengambil data POST
	$name_dept = $_POST['name_department'];
	...
	if (empty ($name_dept))
	{
		...
		$arahan_sql_simpan = "INSERT INTO lt_department(name_department)VALUES('$name_dept')";
		...
		if(mysqli_query($conn,$arahan_sql_simpan))
		{
			...
			redirect("ListDepartment.php?success=1");
		}
		else
		{	
