...
if(isset($_POST['Submit'])) {
	...
	// print_r($_POST);
	// echo "</pre>";
	include("assets/proses/AddDepartment.class.php");
}
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">Add Department Page</li>
                        </ol>
                                ...
                                <form class="needs-validation" novalidate action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" enctype="multipart/form-data" method="post" onSubmit="return capture();">
                                    <div class="form-group row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="inputEmail4" placeholder="Please Insert Department Name" name="name_department">
                                        </div>
                                    </div>
                                    <div class="form-group row">
